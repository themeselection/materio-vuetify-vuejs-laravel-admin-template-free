<template>
  ...
  >
    ...
    >
      <VCard>
        <VImg src="https://cdn.jsdelivr.net/gh/themeselection/ts-assets/materio/materio-vuetify-vuejs-laravel-admin-template-free/banner/materio-vuetify-vuejs-laravel-admin-template-free.png" />
